		...
		// },{
			...
			items: [{
				...
				itemTpl: ["<div class='row-cls'>",
							"<div class='thumb <tpl if=\"Profile.IsOnline\">active</tpl>'<tpl if=\"Profile.PhotoUrl\"> style='background-image: url(\"{Profile.PhotoUrl}\")'<tpl else>style='background-image: url(resources/images/person.png)'</tpl>></div>",//"<div class='thumb' style='background-image: url(\"{PhotoUrl}\")'></div>",
						...
						"<div class='row-cls reverse-cls' style='font-size:0.7em;'>",
							...
							"</tpl>",
						"</div>",
						"<tpl if='Bet.Status==\"Pending\"'><div class='row-cls action-btns <tpl if='!CreatedByMe'>show-accept-btn</tpl>'>",
